...
- Productive-use data granularity — explicitly document whether connection counts or actual productive-use applications.
- Value-chain specificity — document which agricultural value chains are covered.
- Access-vs-use distinction — document whether data captures ownership or actual productive use.
- Access conditions and license.

## Rejection Rule

A dataset is rejected for canonical analysis if grain, date range, license, or method cannot be verified. Datasets with known limitations (e.g., operator-reported data without verification, value-chain-specific studies) may be listed as limited with explicit documentation. Rejected datasets may still be listed as context.

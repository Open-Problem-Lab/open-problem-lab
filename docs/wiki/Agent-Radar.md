...
- **544 total tasks**
- **104 scoped now**
- **440 follow-on tasks still latent**
...
| ------------------------ | ---------- | -------------- | ------------------ | --------------------- |
| `implementation-planner` | 0          | 127            | 0.233              | 0.289                 |
| `field-reality-reviewer` | 0          | 106            | 0.195              | 0.241                 |
| `red-team-reviewer`      | 0          | 105            | 0.193              | 0.239                 |
| `data-cleaner`           | 0          | 101            | 0.186              | 0.23                  |
| `literature-scout`       | 104        | 1              | 0.193              | 0.002                 |
